...
(() => {
  ...
  async function loadUserProfile() {
    ...
    try {
      const response = await fetch('https://serenity-backend-h9vi.onrender.com/api/auth/profile', {
        headers: {
  ...
  avatarInput.addEventListener('change', async function(e) {
    ...
    try {
      const response = await fetch('https://serenity-backend-h9vi.onrender.com/api/upload/avatar', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
